...
- [ ] 游戏基本内容
	...
	- [x] 积分面板更改显示其他队伍的团队积分
	- [x] 小队名字颜色区分，小队装备（染色皮革套）区分
	- [x] 玩家死亡掉落资源，死亡复活CD设置
	- [x] 防御塔强度升级更改：一级伤害低，无击退，攻击速率低，消耗资源少；二级伤害中等，击退低，攻击速率中等，消耗资源中等；二级伤害高，击退高，攻击速率高，消耗资源大
	- [x] 铁匠铺机制更改：铁匠铺NPC从主城获取资源随机造装备，装备玩家，NPC可用，可制造鞘翅，烟花等装备（喷气背包）
	- [x] 队伍数量可以根据配置文件调整
	- [x] 游戏结算
	- [x] 制作成完整的RTS小游戏
- [ ] 测试上线
	- [x] demo内部测试
	- [x] IMC服务器玩家公测，服务器IP：play.imc.re
	- [ ] 游戏正式上线
- [ ] 附加内容
	- [x] 建筑皮肤
